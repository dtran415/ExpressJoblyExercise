...
describe("GET /companies", function () {
  ...
  test("filter by name should work", async function () {
  ...
  test("filter by minEmployees should work", async function () {
  ...
  test("filter by maxEmployees should work", async function () {
  ...
  test("should give error if negative value for minEmployee", async function () {
